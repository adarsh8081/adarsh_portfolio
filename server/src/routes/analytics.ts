...
analytics.get("/overview", authenticateToken, requireAdmin, async (req: AuthRequest, res) => {
	try {
...
// Get top pages
analytics.get("/pages", authenticateToken, requireAdmin, async (req: AuthRequest, res) => {
	try {
		const topPages = [
...
// Get audience data
analytics.get("/audience", authenticateToken, requireAdmin, async (req: AuthRequest, res) => {
	try {
		const audience = {
...
// Get real-time data
analytics.get("/realtime", authenticateToken, requireAdmin, async (req: AuthRequest, res) => {
	try {
		const realtime = {
...
analytics.get("/chatbot", authenticateToken, requireAdmin, async (req: AuthRequest, res) => {
	try {
...
analytics.get("/content", authenticateToken, requireAdmin, async (req: AuthRequest, res) => {
	try {
...
analytics.post("/track", async (req, res) => {
	try {
